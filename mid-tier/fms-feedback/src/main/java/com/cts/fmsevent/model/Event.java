...
public class Event {
	...
	public boolean equals(java.lang.Object o) {
		...
		Event event = (Event) o;
		return Objects.equals(this.eventId, event.eventId) && Objects.equals(this.eventNo, event.eventNo)
				&& Objects.equals(this.month, event.month) && Objects.equals(this.location, event.location)
				&& Objects.equals(this.beneficiaryName, event.beneficiaryName)
				&& Objects.equals(this.address, event.address) && Objects.equals(this.councilName, event.councilName)
				&& Objects.equals(this.project, event.project) && Objects.equals(this.category, event.category)
	...
	@Override
	public int hashCode() {
		return Objects.hash(eventId, eventNo, month, location, beneficiaryName, address, councilName, project, category,
